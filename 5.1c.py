...
device = input('Enter a name of a device: ')
list_parameters = sorted(london_co[device])
list_parameters = ', '.join(list_parameters)
print('Enter parameter ' + '(' + list_parameters + ')' + ': ')
parameter = input()
print(london_co[device].get(parameter, 'Wrong name of parameter!'))