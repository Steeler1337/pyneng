...
def generate_access_config(intf_vlan_mapping, access_template, psecurity=None):
    ...
    for k, v in intf_vlan_mapping.items():
        interface = f'interface {k}'
        configuration.append(interface)
...
result_security = generate_access_config(access_config, access_mode_template, port_security_template)
print(result_security)
print('-------------------------')
